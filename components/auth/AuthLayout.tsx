...
import { Flame, CheckCircle2, Trophy, Sparkles, TrendingUp, ShieldCheck, Zap } from 'lucide-react';
...
export default function AuthLayout({ children, activeTab }: AuthLayoutProps) {
  return (
    <div className="min-h-dvh w-full flex items-center justify-center relative overflow-hidden bg-[#07090E] text-white font-['Inter'] p-4 sm:p-6 md:p-10 selection:bg-indigo-500 selection:text-white">
      ...
      <motion.div
        ...
        className="absolute top-1/3 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[42rem] h-[42rem] rounded-full bg-gradient-to-tr from-indigo-600/25 via-purple-600/20 to-pink-500/10 blur-[130px] pointer-events-none"
      />
      <motion.div
        animate={{
          scale: [1, 1.15, 1],
        ...
        className="absolute bottom-10 right-10 w-[30rem] h-[30rem] rounded-full bg-gradient-to-br from-blue-600/20 via-emerald-500/15 to-purple-600/20 blur-[120px] pointer-events-none"
      />
      ...
      <div className="relative z-10 w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        {/* Left Side: Interactive Showcase Showcase Panel */}
        <motion.div
        ...
        >
          ...
          <Link href="/" className="inline-flex items-center gap-3 group w-fit">
            <div className="w-11 h-11 relative flex items-center justify-center p-2 rounded-2xl bg-gradient-to-tr from-white/15 to-white/5 border border-white/10 shadow-inner group-hover:scale-105 transition-transform">
              <Image
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-slate-400">Habit & Goal Engine</span>
            </div>
          </Link>

          {/* Value Prop Headline */}
          <div className="space-y-3">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold font-['Outfit'] leading-[1.15] tracking-tight text-white">
          ...
          <div className="relative rounded-3xl bg-white/[0.03] backdrop-blur-xl border border-white/[0.08] p-5 sm:p-6 shadow-2xl overflow-hidden space-y-4">
            {/* Subtle card glow */}
        ...
        >
          <div className="relative z-10 rounded-3xl bg-[#11141F]/90 backdrop-blur-2xl border border-white/[0.12] p-6 sm:p-8 shadow-[0_32px_80px_rgba(0,0,0,0.85),0_1px_1px_rgba(255,255,255,0.08)_inset]">
            {children}
          </div>
        </motion.div>
